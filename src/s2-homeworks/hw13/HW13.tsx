...
const HW13 = () => {
    ...
    const send = (x?: boolean | null, y?:string) => () => {
        const url =
            x === null
            ...
            <div className={s2.hw}>
                <div className={s.buttonsContainer}>
                    <SuperButton
                        ...
                        xType={'secondary'}
                        className={s.button}
                        disabled={disabled==='hw13-send-true'}
                    ...
                    <SuperButton
                        ...
                        xType={'secondary'}
                        className={s.button}
                        disabled={disabled==='hw13-send-false'}
                    ...
                    <SuperButton
                        ...
                        xType={'secondary'}
                        className={s.button}
                        disabled={disabled==='hw13-send-undefined'}
                    ...
                    <SuperButton
                        ...
                        xType={'secondary'}
                        className={s.button}
                        disabled={disabled==='hw13-send-null'}
